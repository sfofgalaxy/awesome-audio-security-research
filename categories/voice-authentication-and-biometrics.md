...
| Year | Venue | Paper | Tags |
| --- | --- | --- | --- |
| 2026 | ICASSP | BeepBeep: Leveraging Structural Attenuation for Robust Device-to-Device Authentication | authentication, device, paper-11368 |
| 2026 | ICASSP | LENSLESSMIC: AUDIO ENCRYPTION AND AUTHENTICATION VIA LENSLESS COMPUTATIONAL IMAGING | authentication, encryption, paper-14650 |
| 2026 | ICASSP | HYBRID PRUNING: IN-SITU COMPRESSION OF SELF-SUPERVISED SPEECH MODELS FOR SPEAKER VERIFICATION AND ANTI-SPOOFING | anti-spoofing, speaker-verification, paper-1139 |
| 2025 | IEEE S&P | Lombard-VLD: Voice Liveness Detection based on Human Auditory Feedback | liveness, defense |
| 2025 | ICASSP | Explaining Speaker and Spoof Embeddings via Probing | anti-spoofing, interpretability, id-50930 |
| 2025 | ICASSP | FreqSense: Universal and Low-Latency Adversarial Example Detection for Speaker Recognition with Interpretability in Frequency Domain | adversarial, speaker-recognition, id-48236 |
| 2025 | Interspeech | [Towards Secure User Authentication for Headphones via In-Ear or In-Earcup Microphones](https://www.isca-archive.org/interspeech_2025/shashaank25_interspeech.html) | authentication, headphone |
