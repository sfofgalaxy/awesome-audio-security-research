...
| Category | File |
| --- | --- |
| Audio Deepfake, Voice Cloning, and Spoofing | [audio-deepfake-voice-cloning-and-spoofing.md](../categories/audio-deepfake-voice-cloning-and-spoofing.md) |
| Voice Privacy, Anonymization, and Speaker Protection | [voice-privacy-anonymization-and-speaker-protection.md](../categories/voice-privacy-anonymization-and-speaker-protection.md) |
| Watermarking, Provenance, and Data Rights | [watermarking-provenance-and-data-rights.md](../categories/watermarking-provenance-and-data-rights.md) |
| ASR and Speech Translation Security | [asr-and-speech-translation-security.md](../categories/asr-and-speech-translation-security.md) |
| Audio-Language Model Safety | [audio-language-model-safety.md](../categories/audio-language-model-safety.md) |
| Side Channels and Physical Eavesdropping | [side-channels-and-physical-eavesdropping.md](../categories/side-channels-and-physical-eavesdropping.md) |
| Music and Singing Voice Security | [music-and-singing-voice-security.md](../categories/music-and-singing-voice-security.md) |
| Voice Authentication and Biometrics | [voice-authentication-and-biometrics.md](../categories/voice-authentication-and-biometrics.md) |
...
| AI | NeurIPS | Collected | Pending: accepted list not public as of 2026-09-07; author notification is 2026-09-24 |
| NLP | ACL | Collected | Collected |
| NLP | EMNLP | Collected | Pending: accepted-page content still carries EMNLP 2025 metadata/content as of 2026-09-07 |
| Speech | ICASSP | Collected from official program API | Collected |
| Speech | Interspeech | Collected | Preliminary programme collected; ISCA archive not public as of 2026-09-07 |
...
| ACL 2026 | <https://2026.aclweb.org/program/accepted_papers/> and <https://aclanthology.org/volumes/2026.acl-long/> |
| EMNLP 2025 | <https://aclanthology.org/events/emnlp-2025/> |
| EMNLP 2026 | <https://2026.emnlp.org/calls/main_conference_papers/> and <https://2026.emnlp.org/program/main_papers/> |
