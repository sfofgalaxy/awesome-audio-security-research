...
This taxonomy separates the collection by threat surface first, then by broad research role. A paper should have one primary category, one broad section, and may carry several secondary tags.
